...
#define S_FUNCTION_NAME  mci_get_analog
...
#include <Windows.h>
#include <string.h>
typedef sint32 (*mcigetanalog_type)(MOTOR_ENUM_TYPE motor, MCI_AI_TYPE read_data);
mcigetanalog_type MciGetAnalog = NULL;
...
#define MDL_INITIALIZE_CONDITIONS   /* Change to #undef to remove function */
  ...
  static void mdlInitializeConditions(SimStruct *S)
  {
	  ...
	  {
		  MciGetAnalog = mci->methods[MCI_GET_ANG];
		  if (MciGetAnalog == NULL)
		  {
...
//    real_T       *y = ssGetOutputPortSignal(S,0);
    ...
    if ( MciGetAnalog != NULL)
        *y = MciGetAnalog(MOTOR0, read_data); 
}
