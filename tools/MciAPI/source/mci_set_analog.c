...
#define S_FUNCTION_NAME  mci_set_analog
...
#include <Windows.h>
#include <string.h>
typedef uint8 (*mcisetanalog_type)(MOTOR_ENUM_TYPE motor, MCI_AO_TYPE read_data, sint32 value);
mcisetanalog_type MciSetAnalog = NULL;
...
#define MDL_INITIALIZE_CONDITIONS   /* Change to #undef to remove function */
  ...
  static void mdlInitializeConditions(SimStruct *S)
  {
	  ...
	  {
		  MciSetAnalog = mci->methods[MCI_SET_ANG];
		  if (MciSetAnalog == NULL)
		  {
...
{
    int32_T       *y = ssGetInputPortSignal(S,0);
    int write_data;
    MciStruct* mci;
    ...
    if ( MciSetAnalog != NULL)
        MciSetAnalog(MOTOR0, write_data, *y); 
}
