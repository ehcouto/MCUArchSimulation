...
Compressor.mechanical.l_conrod = 0.03847; %Connection rod length [m]
Compressor.mechanical.stroke = 0.015; %Stroke [m]
Compressor.mechanical.bore = 0.0225; %Bore [m]
Compressor.mechanical.d_m = 0.002; %Piston pin offset [m]
Compressor.mechanical.rho_pis = 7850; %Piston density [kg/m3]
Compressor.mechanical.J = 0.00039743; %Moment of inertia [kg.m2]
Compressor.mechanical.c = 0.02762; %Clearance ratio
Compressor.mechanical.d_sv = 0.009441; %Suction valve orifice diameter [m]
Compressor.mechanical.c_sv = 0.048; %Effective flow area coefficient - Suction valve
Compressor.mechanical.d_dv = 0.005046; %Discharge valve orifice diameter [m]
