...
//=====================================================================================================================
#define SR_FLOW_INITILIZE()
#define SR_FLOW_CHECK_INIT()
#define SR_FLOW_CHECK_MAIN()
#define SR_FLOW_CHECK_ISR()
#define SR_FLOW_CHECK_LOWPOWER()
...
//! the new version introduces the SRMain__FastTimerIsr in case the interrupt period is lower than 1ms
//! that is the base time period in Nucleus Architecture
#ifdef TIMERINTERRUPT_SYSTEM_TICK_INTERVAL
    #define NUCLEUS_FAST_TIMER_ISR
#endif
