...
uint32 Dbg_R1_021_A = 0;
uint32 Dbg_R1_021_B = 0;
uint32 Dbg_R1_021_C = 0;
 ...
 *  @return     none
 */
void SRMCAtod__EnableDiagnostic(signed short int commanded_threshold)
{
...
SRMCATOD_DIAG_ERROR_TYPE SRMCAtod__GetDiagnosticFeedback(void)
{
	...
	current_status = SRMCATOD__GET_DIAGNOSTIC_FEEDBACK;
